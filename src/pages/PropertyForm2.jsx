...
import { 
  ...
  CheckCircle2, MapPin, Star, Search
} from 'lucide-react';
...
export default function PropertyForm2() {
  ...
  // Panel / Veri tabanından sosyal alan listesini çeken query
  ...
  // Arama motoru filtresi (Kategori ayrımı yapmadan tek liste)
  ...
  // Yukarıda listelenecek "Seçilenler" filtresi
      ...
      <div className="space-y-6">
        ...
        {activeTab === 'features' && (
          <div className="space-y-6">
            ...
            {/* Üst Alan: Durum & Regülasyon Kriterleri Grid Yapısı */}
            ...
            {/* Alt Alan: Sosyal Donatılar ve İlan Özellikleri (TEK KUTU PANEL DURUMUNDA AYNI TASARIM) */}
            <div className="bg-card rounded-xl border border-border p-5 space-y-5 shadow-2xs">
              ...
              {/* SEÇİLEN ÖZELLİKLERÜNÜN PANEL İÇERİSİNDE EN ÜSTTE SEÇİLDİ OLARAK GELDİĞİ ALAN */}
                ...
                <div className="bg-emerald-50/20 border border-emerald-500/10 rounded-xl p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    {selectedFeaturesItems.map(feat => (
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          {/* Panelden gelen farklı emojileri veya ikonları tam eşler */}
              ...
              {/* TÜM SOSYAL DONATILAR - GRUPLAMA OLMADAN, DÜZ GRİD MİMARİSİ (DURUM & REGÜLASYON İLE BİREBİR AYNI KUTU) */}
                ...
                {filteredFeatures.length > 0 ? (
                  filteredFeatures.map(feat => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          {/* Panelden çekilen farklı emojiler (emoji yoksa icon alanına bakar) */}
                          <span className="text-lg">{feat.emoji || feat.icon || '✨'}</span>
